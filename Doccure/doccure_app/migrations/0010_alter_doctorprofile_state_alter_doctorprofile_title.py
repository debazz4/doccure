# Generated by Django 5.1.5 on 2025-02-11 02:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('doccure_app', '0009_alter_doctorprofile_state_alter_doctorprofile_title'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='doctorprofile',
            name='title',
            field=models.CharField(choices=[('Dr', 'Doctor'), ('MD', 'MD'), ('DO', 'DO')], max_length=30),
        ),
    ]
